...
/**
 * TripSummaryScreen - Trip Summary for Both Driver and Passenger
 *
 * IMPLEMENTATION:
 * - Displays trip details (distance, duration, fare, etc.)
 * - Shows driver/passenger info depending on user role
...
export default function TripSummaryScreen() {
  ...
  const { rideId, userRole } = useLocalSearchParams<{
    rideId: string;
    userRole?: string;
  }>();
          ...
          <ThemedView style={styles.card} p={20} mb={16}>
            ...
            >
              ...
              <ThemedView bg="transparent" align="center">
                ...
                <ThemedText weight="bold" color="#6C006C">
            ...
            <ThemedView flexDirection="row" align="center" bg="transparent">
              ...
              {tripSummary.rating && (
                <ThemedView flexDirection="row" align="center" bg="transparent">
                  ...
                  <ThemedText weight="bold" ml={4}>
                    {tripSummary.rating.toFixed(1)}
                  </ThemedText>
                </ThemedView>
              )}
            </ThemedView>
