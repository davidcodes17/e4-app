        ...
        >
          ...
          <ThemedView w="100%" bg="transparent">
            ...
            <ThemedText
              ...
              lineHeight={24}
            >
              From quick trips to long journeys, E4 connects you with trusted
              drivers at fair prices.
            </ThemedText>
          </ThemedView>
          ...
          <ThemedView gap={20} bg="transparent">
            ...
            >
              <ThemedText size="sm" color="#E0E0E0">
                Already have an account?{" "}
              </ThemedText>
              <ThemedText size="sm" color="white" weight="bold">
                Login
              </ThemedText>
            </TouchableOpacity>
          </ThemedView>
